...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form class="ajax-submit2" method="post" autocomplete="off"
                        action="{{ route('promotions.update', $promotion->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="promotion_type"
                                        data-selected="{{ $promotion->promotion_type }}">
                                        <option value="image">{{ _lang('Image') }}</option>
                                        <option value="video">{{ _lang('Video') }}</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-12 {{ $promotion->promotion_type != 'image' ? 'd-none' : '' }}">
                                <div class="form-group">
                                    <label class="control-label">{{ _lang('Image') }}</label>
                                    <input type="file" class="form-control dropify" name="image"
                                        data-allowed-file-extensions="png jpg jpeg PNG JPG JPEG"data-default-file="{{ $promotion->promotion_type == 'image' ? asset($promotion->image) : '' }}">
                                </div>
                            </div>
                            <div class="col-md-12 {{ $promotion->promotion_type != 'video' ? 'd-none' : '' }}">
                                <div class="form-group">
                                    ...
                                    <div class="text-center">
                                        <div action="{{ url('promotions/video') }}" class="dropzone"
                                            ...
                                            <input type="hidden" name="video"
                                                value="{{ $promotion->promotion_type == 'video' ? $promotion->video : '' }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="action_url"
                                        value="{{ $promotion->action_url }}" required>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="status"
                                        data-selected="{{ $promotion->status }}" required>
