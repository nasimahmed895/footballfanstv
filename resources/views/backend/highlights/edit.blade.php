...
@section('content')
    ...
    <form method="post" class="ajax-submit2" autocomplete="off" action="{{ route('highlights.update', $highlight->id) }}"
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="sports_type_id" required>
                                    ...
                                    {{ create_option('sports_types', 'id', ['-', 'sports_name', 'sports_skq'], $highlight->sports_type_id) }}
                                </select>
                            </div>
                        </div> --}}
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="match_title"
                                        value="{{ $highlight->match_title }}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="status"
                                        data-selected="{{ $highlight->status }}" required>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="cover_image_type"
                                        data-selected="{{ $highlight->cover_image_type }}">
                            ...
                            <div class="col-md-12 d-none">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="cover_url"
                                        value="{{ $highlight->cover_url }}">
                                </div>
                            </div>

                            <div class="col-md-12 {{ $highlight->cover_image_type == 'image' ? '' : ' d-none' }}">
                                <div class="form-group">
                                    <label class="control-label">{{ _lang('Image') }}</label>
                                    <input type="file" class="form-control dropify" name="cover_image"
                                        data-allowed-file-extensions="png jpg jpeg PNG JPG JPEG"data-default-file="{{ $highlight->cover_image ? asset($highlight->cover_image) : '' }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group cover_image">
                                    @if ($highlight->cover_image_type == 'url')
                                        <img src="{{ $highlight->cover_url }}" style="width: 150px; border-radius: 10px;">
                                    @endif
                                </div>
                            </div>
                            {{-- <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="team_one_name"
                                        value="{{ $highlight->team_one_name }}" required>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="team_one_image_type"
                                        data-selected="{{ $highlight->team_one_image_type }}">
                                        <option value="none">{{ _lang('None') }}</option>
                                        <option value="url">{{ _lang('Url') }}</option>
                                        <option value="image">{{ _lang('Image') }}</option>
                                    </select>
                            ...
                            <div class="col-md-12 d-none">
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control dropify" name="team_one_image"
                                        data-allowed-file-extensions="png jpg jpeg PNG JPG JPEG"data-default-file="{{ $highlight->team_one_image ? asset($highlight->team_one_image) : '' }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group team_one_image">
                                    @if ($highlight->team_one_image_type == 'url')
                                        <img src="{{ $highlight->team_one_url }}"
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="team_two_name"
                                        value="{{ $highlight->team_two_name }}" required>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="team_two_image_type"
                                        data-selected="{{ $highlight->team_two_image_type }}">
                                        <option value="none">{{ _lang('None') }}</option>
                                        <option value="url">{{ _lang('Url') }}</option>
                                        <option value="image">{{ _lang('Image') }}</option>
                                    </select>
                            ...
                            <div class="col-md-12 d-none">
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control dropify" name="team_two_image"
                                        ...
                                        data-default-file="{{ $highlight->team_two_image ? asset($highlight->team_two_image) : '' }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group team_two_image">
                                    @if ($highlight->team_two_image_type == 'url')
                                        <img src="{{ $highlight->team_two_url }}"
                                            style="width: 150px; border-radius: 10px;">
                                    @endif
                                </div>
                            </div>
                            ...
                            @foreach (App\Models\HighlightStreamingSource::where('highlight_id', $highlight->id)->get() as $key => $streaming_source)
                                <div class="field-group params-card mx-4 my-2 row" style="width: 100%;">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="control-label"
                                                id="block__country__label">{{ _lang('Block/Unblock Countries') }}</label>
                                            <select class="form-control select2 countries"
                                                data-selected="{{ json_encode(explode(',', $streaming_source->block_country)) }}"
                                                multiple>
                                                {{ get_country_list() }}
                                            </select>
                                            <input class="block_country" type="hidden" name="block_country[]"
                                                value="{{ $streaming_source->block_country }}">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <label class="switch">
                                                <input type="hidden" name="is_block_them[]" value="0"
                                                    class="default_block_them"
                                                    {{ $streaming_source->is_block_them ? 'disabled' : '' }}>
                                                <input type="checkbox" name="is_block_them[]" value="1"
                                                    {{ $streaming_source->is_block_them ? 'checked' : '' }}
                                                    class="is_block_them">
